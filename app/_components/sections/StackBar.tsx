...
export default function StackBar() {
  return (
    <section
      ...
      className="anim-fade-up delay-300 -mx-6 mt-20 flex items-center gap-8 overflow-hidden border-y border-light-border py-4 sm:-mx-12 dark:border-dark-border"
    >
      <div className="flex shrink-0 items-center gap-2 pl-6 sm:pl-12">
        <span aria-hidden="true" className="status-dot" />
        <span className="badge tracking-wide whitespace-nowrap text-light-text-secondary dark:text-dark-text-secondary">
          STACK & PHILOSOPHY
        </span>
      </div>
